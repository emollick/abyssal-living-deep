...
assert.deepEqual(normalizeGenerator({relief:'NaN',life:-20,shoal:200,clarity:0}),{relief:1,life:0,height:1,shoal:2,clarity:.35,current:1,glow:1,upwelling:.65,predators:1,benthos:1,jellies:.65});checks++;
